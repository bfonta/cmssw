#ifndef RecoLocalCalo_HGCalRecProducers_HEFRecHitFromSoA_h
#define RecoLocalCalo_HGCalRecProducers_HEFRecHitFromSoA_h
...
class HEFRecHitFromSoA : public edm::stream::EDProducer<edm::ExternalWork> {
public:
...
#endif  //RecoLocalCalo_HGCalRecProducers_HEFRecHitFromSoA_h
