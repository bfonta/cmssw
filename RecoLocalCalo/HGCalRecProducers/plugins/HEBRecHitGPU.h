#ifndef RecoLocalCalo_HGCalRecProducers_HEBRecHitGPU_h
#define RecoLocalCalo_HGCalRecProducers_HEBRecHitGPU_h
...
#endif  //RecoLocalCalo_HGCalRecProducers_HEBRecHitGPU_h
