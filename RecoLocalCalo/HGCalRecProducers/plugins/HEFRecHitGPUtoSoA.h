#ifndef RecoLocalCalo_HGCalRecProducers_HEFRecHitGPUtoSoA_h
#define RecoLocalCalo_HGCalRecProducers_HEFRecHitGPUtoSoA_h
...
#endif  //RecoLocalCalo_HGCalRecProducers_HEFRecHitGPUtoSoA_h
