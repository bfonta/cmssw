#ifndef RecoLocalCalo_HGCalRecProducers_HEFRecHitGPU_h
#define RecoLocalCalo_HGCalRecProducers_HEFRecHitGPU_h
...
#endif  //RecoLocalCalo_HGCalRecProducers_HEFRecHitGPU_h
