...
"""
print('---process.ecalUncalibRecHitProducerGPU---')
for k, v in process.ecalUncalibRecHitProducerGPU.__dict__.items():
    print(k, v)
print('')
print('==========================')
print('')
print('---process.ecalCPUUncalibRecHitProducer---')
for k, v in process.ecalCPUUncalibRecHitProducer.__dict__.items():
    print(k, v)
"""
