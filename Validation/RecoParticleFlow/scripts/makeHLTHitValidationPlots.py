...
if __name__ == '__main__':
    ...
    if args.digis:
        vars2D = {
            'En_Eta': dict(xtitle='Energy [GeV]', ytitle=r'$\eta$', var='# EB Digis'),
            'En_Phi': dict(xtitle='Energy [GeV]', ytitle=r'$\phi$', var='# EB Digis'),
            'En_Mult': dict(xtitle='Energy [GeV]', ytitle='Max(Digi)', var='# EB Digis'),
            'Mult_Eta': dict(xtitle='Multiplicity', ytitle=r'$\eta$', var='# EB Digis'),
            'Mult_Phi': dict(xtitle='Multiplicity', ytitle=r'$\phi$', var='# EB Digis'),
            'Digi_X': dict(xtitle='Max(Digi)', ytitle=r'X', var='# EE Digis'),
            'Digi_Y': dict(xtitle='Max(Digi)', ytitle=r'Y', var='# EE Digis'),
            'ADC_X': dict(xtitle='Max(ADC)', ytitle=r'X', var='# EE Digis'),
            'ADC_Y': dict(xtitle='Max(ADC)', ytitle=r'Y', var='# EE Digis'),
        }
    else:
        vars2D = {
