#ifndef CUDADAtaFormats_HGCal_HGCCLUEGPUHitsProduct_H
#define CUDADAtaFormats_HGCal_HGCCLUEGPUHitsProduct_H
...
public:
  ...
  HGCCLUEGPUHitsProduct(const HGCCLUEGPUHitsProduct &) = delete;
  HGCCLUEGPUHitsProduct &operator=(const HGCCLUEGPUHitsProduct &) = delete;
  HGCCLUEGPUHitsProduct(HGCCLUEGPUHitsProduct &&) = default;
  HGCCLUEGPUHitsProduct &operator=(HGCCLUEGPUHitsProduct &&) = default;

  HGCCLUEHitsSoA get() {
    HGCCLUEHitsSoA soa;
    soa.rho = reinterpret_cast<float *>(mMemCLUEHitsDev.get());
  ...
  ConstHGCCLUEHitsSoA get() const {
    ...
    soa.rho = reinterpret_cast<float const*>(mMemCLUEHitsDev.get());
    soa.delta = soa.rho + pad_;
...
#endif  //CUDADAtaFormats_HGCal_HGCCLUEGPUHitsProduct_H
