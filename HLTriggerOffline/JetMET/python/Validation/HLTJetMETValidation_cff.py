...
met_common_analyzers = [hltMetAnalyzerPF, hltMetAnalyzerPFCalo, hltMetTypeOneAnalyzerPF] 
...
HLTJetMETValSeq = cms.Sequence(
    ...
    + _sumModules(met_run3_analyzers)
)

_phase2_HLTJetMETValSeq = HLTJetMETValSeq.copyAndExclude(met_run3_analyzers)
_phase2_HLTJetMETValSeq += cms.Sequence(_sumModules(met_ph2_analyzers))
